...
const replacements = [
    ...
    { from: "apiSend(`/api/company-groups/${selectedGroupId}/companies/${cid}`, 'DELETE')", to: "apiSend('DELETE', `/api/company-groups/${selectedGroupId}/companies/${cid}`)" },
    { from: "apiSend(`/api/company-groups/${selectedGroupId}/doctors`, 'POST')", to: "apiSend('POST', `/api/company-groups/${selectedGroupId}/doctors`)" },
    { from: "apiSend(`/api/company-groups/${selectedGroupId}/doctors/${docId}`, 'DELETE')", to: "apiSend('DELETE', `/api/company-groups/${selectedGroupId}/doctors/${docId}`)" },
];
