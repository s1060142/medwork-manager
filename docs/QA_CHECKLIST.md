...
- [ ] Master Data aggiornato (`MasterDataController`)
...
- [ ] HrImportExportDialog funzionante
...
- [ ] `VisitExamsController` endpoint operativo
...
- [ ] `DeadlineEngineController` operativo
...
- [ ] **Admin123! backdoor**: rimosso da codice produzione (solo test fixtures)
- [ ] **JWT secret**: non hardcoded, da gestire con vault (Key Vault)
...
- [ ] **EPPlus 8.7.0**: aggiornare a 5+ o sostituire con ClosedXML
...
*Stack: ASP.NET Core 10, EF Core 10.0.12, EPPlus 8.7.0*
