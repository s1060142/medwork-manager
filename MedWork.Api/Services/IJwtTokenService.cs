...
public interface IJwtTokenService
{
    ...
    string GenerateRefreshToken(string username, string role, int tenantId = 1);
    string GenerateRefreshToken(int userId, string email, List<string> roles, IEnumerable<string> permissions, int tenantId);
